...
let openBtn_SettingMb = document.querySelector('.settings-header .btnOpenSettings');
...
//See More
let list_btnSeeMore_SettingMb = document.querySelectorAll('.settingsMb .seeMore');
let subMenu_SettingMb = document.querySelector('.settingsMb .sub-menu-mb');

list_btnSeeMore_SettingMb.forEach()