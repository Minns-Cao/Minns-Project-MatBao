...
const buttonSeeMore_FeatureComparison = document.querySelector("#featuresComparison .btnSeeMore");
const collapsedTable = document.querySelectorAll(
    "#featuresComparison .featuresHidden"
);
