...
let buttonsInWP = document.querySelector(".topbannerWordpress .buttons");
let btnLinux = document.querySelector(".btnLinux");
let btnWindows = document.querySelector(".btnWindows");

buttonsInWP.addEventListener("click", () => {
    let target = event.target;
    let buttonIsActive = document.querySelector(".buttonIsActive");
    console.log(buttonIsActive);
    buttonIsActive.classList.remove(".buttonIsActive");
    

    if (target.contains(btnLinux)) {
        btnLinux.classList.add("buttonIsActive");
    } else if (target.contains(btnWindows)) {
        btnLinux.classList.add("buttonIsActive");
    }
});
