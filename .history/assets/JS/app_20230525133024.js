...
document.getElementById("prev").addEventListener("click", () => {
    ...
    // thêm animation
    let descSlide = list_itemSlide[2].querySelector(".sliderEvaluate .slide .desc");
    let nameSlide = list_itemSlide[2].querySelector(".sliderEvaluate .slide .name");
    descSlide.classList.add('animationSlide_desc');
    descSlide.addEventListener('animationend', ()=> {
        descSlide.classList.remove('animationSlide_desc');
    });
});
