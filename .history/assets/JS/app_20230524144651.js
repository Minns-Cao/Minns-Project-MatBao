...
list_inputSwitch.forEach((inputSwitch) => {
    inputSwitch.addEventListener('click', ()=> {
        if(inputSwitch.checked){
            ...
            //change cost
            let cloudSever = document.querySelector("#cloudSever");
            let cost = cloudSever.querySelector(".cost");
            let ssdCost = cost.textContent.split(".").join('') - (-10000)
            console.log(cost.textContent.split(".").join('') - (-10000) );
