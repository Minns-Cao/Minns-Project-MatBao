...
const buttonSeeMore = document.querySelector(".btnSeeMore");
const featuresHidden = document.querySelectorAll("#serviceFeatures .featuresHidden");

console.log(featuresHidden);
