...
// =====================Slider=======================
let list_itemSlide = document.querySelectorAll('.sliderEvaluate .slide .item');
document.getElementById('next').addEventListener('click', ()=>{
    document.querySelector('.sliderEvaluate .slide').prepend(list_itemSlide[list_itemSlide.length - 1])
});